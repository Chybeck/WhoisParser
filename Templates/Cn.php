...
class Cn extends Regex
{
    ...
    protected $blocks = array(
            ...
            8 => '/(Registration Date|Registration Time|Created On)(?>[\x20\t]*):(?>[\x20\t]*)(.*?)$/is',
            9 => '/Zone (ID|Name)(?>[\x20\t]*):(?>[\x20\t]*)(.*?)(?=(Name Server\:|Nameservers\:))/is',
            10 => '/^Sponsoring Registrar:\s+(.*)\n/im');
    ...
    protected $blockItems = array(
            ...
            8 => array('/^Registration (Date|Time)(?>[\x20\t]*):(?>[\x20\t]*)(.+)$/im' => 'created', 
                    '/^Created On(?>[\x20\t]*):(?>[\x20\t]*)(.+)$/im' => 'created', 
                    '/^Expires On(?>[\x20\t]*):(?>[\x20\t]*)(.+)$/im' => 'expires', 
                    '/^Expiration (Date|Time)(?>[\x20\t]*):(?>[\x20\t]*)(.+)$/im' => 'expires', 
            ...
            10 => array(
                    '/^Sponsoring Registrar:\s+(.*)$/im' => 'registrar:name',
             )
             );
